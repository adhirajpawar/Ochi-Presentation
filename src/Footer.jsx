...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 py-20 px-20">
        <div className="w-1/2 h-full flex flex-col justify-between">
       <div className="Heading"> 
        <h1 className="text-[6vw] font-bold leading-none -mb-15">EYE-</h1>
       <h1 className="text-[6vw] font-bold leading-none -mb-15">OPENING</h1>
        </div>
       <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-1/2 ">
        <h1 className="text-[6vw] font-bold leading-none -mb-15">PRESENTATION    
        </h1>
        ...
        <div className="dets font-['Neue_Montreal'] mt-10">
            ...
            <a className="block text-xl" href="#">202-1965 W 4th Ave <br />
            Vancouver, Canada</a>
        </div>
